...
public class Floating_six extends Service {


	private WindowManager windowManager6;
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
       ...
       PackageManager manager = this.getPackageManager();
		...
		windowManager6 = (WindowManager) getSystemService(WINDOW_SERVICE);
		...
		windowManager6.addView(chatHead, params);
			...
			chatHead.setOnTouchListener(new View.OnTouchListener() {
				...
				@Override public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_MOVE:
						...
						try{
							windowManager6.updateViewLayout(chatHead, paramsF);
						}
						catch (IllegalArgumentException e){
							windowManager6.addView(chatHead, paramsF);
						}
						break;
					}
					return false;
	...
	public void onDestroy() {
		...
		if (chatHead.isShown()) {
			windowManager6.removeView(chatHead);
		}
		MainScope.six = false;
		MainScope.sixS = false;
		System.out.println("Channel SIX Reset");
	}
