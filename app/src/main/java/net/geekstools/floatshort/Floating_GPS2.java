...
public class Floating_GPS2 extends Service {


	private WindowManager windowManagerG2;
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
       ...
       PackageManager manager = this.getPackageManager();
		...
		windowManagerG2 = (WindowManager) getSystemService(WINDOW_SERVICE);
		...
		windowManagerG2.addView(chatHead, params);
		...
		try {
			chatHead.setOnTouchListener(new View.OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_MOVE:
						...
						windowManagerG2.updateViewLayout(chatHead, paramsF);
						break;
					}
					return false;
				}
			...
			chatHead.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if(RecieverGPS.gps2 == false){
						stopService(new Intent(getApplicationContext(), Floating_GPS2.class));
						run = false;
	...
	public void onCreate() {
		...
		System.out.println("Floating_GPS2");
	}
	...
	public void onDestroy() {
		...
		if (chatHead.isShown()) {
			windowManagerG2.removeView(chatHead);

			RecieverGPS.gps2 = true;
			System.out.println("Channel Floating_GPS2 Reset");
		}
	}
