...
public class Floating_seven extends Service {


	private WindowManager windowManager7;
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
       ...
       PackageManager manager = this.getPackageManager();
		...
		windowManager7 = (WindowManager) getSystemService(WINDOW_SERVICE);
		...
		windowManager7.addView(chatHead, params);
			...
			chatHead.setOnTouchListener(new View.OnTouchListener() {
				...
				@Override public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_MOVE:
						...
						try{
							windowManager7.updateViewLayout(chatHead, paramsF);
						}
						catch (IllegalArgumentException e){
							windowManager7.addView(chatHead, paramsF);
						}
						break;
					}
					return false;
	...
	public void onDestroy() {
		...
		if (chatHead.isShown()) {
			windowManager7.removeView(chatHead);
		}
		MainScope.seven = false;
		MainScope.sevenS = false;
		System.out.println("Channel SEVEN Reset");
	}
