...
public class Floating_ten extends Service {


	private WindowManager windowManager10;
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
       ...
       PackageManager manager = this.getPackageManager();
		...
		windowManager10 = (WindowManager) getSystemService(WINDOW_SERVICE);
		...
		params.x = 30+ MainScope.E;
		params.y = 130+ MainScope.E;
		params.windowAnimations = android.R.style.Animation_Dialog;

		windowManager10.addView(chatHead, params);
			...
			chatHead.setOnTouchListener(new View.OnTouchListener() {
				...
				@Override public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_MOVE:
						...
						try{
							windowManager10.updateViewLayout(chatHead, paramsF);
						}
						catch (IllegalArgumentException e){
							windowManager10.addView(chatHead, paramsF);
						}
						break;
					}
					return false;
	...
	public void onDestroy() {
		...
		if (chatHead.isShown()) {
			windowManager10.removeView(chatHead);
		}
		MainScope.ten = false;
		MainScope.tenS = false;
		System.out.println("Channel TEN Reset");
	}
