...
public class Floating_nine extends Service {


	private WindowManager windowManager9;
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
       ...
       PackageManager manager = this.getPackageManager();
		...
		windowManager9 = (WindowManager) getSystemService(WINDOW_SERVICE);
		...
		windowManager9.addView(chatHead, params);
			...
			chatHead.setOnTouchListener(new View.OnTouchListener() {
				...
				@Override public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_MOVE:
						...
						try{
							windowManager9.updateViewLayout(chatHead, paramsF);
						}
						catch (IllegalArgumentException e){
							windowManager9.addView(chatHead, paramsF);
						}
						break;
					}
					return false;
	...
	public void onDestroy() {
		...
		if (chatHead.isShown()) {
			windowManager9.removeView(chatHead);
		}
		MainScope.nine = false;
		MainScope.nineS = false;
		System.out.println("Channel NINE Reset");
	}
