...
public class Floating_four extends Service {


	private WindowManager windowManager4;
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
       ...
       PackageManager manager = this.getPackageManager();
		...
		windowManager4 = (WindowManager) getSystemService(WINDOW_SERVICE);
		...
		windowManager4.addView(chatHead, params);
			...
			chatHead.setOnTouchListener(new View.OnTouchListener() {
				...
				@Override public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_MOVE:
						...
						try{
							windowManager4.updateViewLayout(chatHead, paramsF);
						}
						catch (IllegalArgumentException e){
							windowManager4.addView(chatHead, paramsF);
						}
						break;
					}
					return false;
	...
	public void onDestroy() {
		...
		if (chatHead.isShown()) {
			windowManager4.removeView(chatHead);
		}
		MainScope.four = false;
		MainScope.fourS = false;
		System.out.println("Channel FOUR Reset");
	}
