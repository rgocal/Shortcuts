...
public class Floating_WiFi2 extends Service {


	private WindowManager windowManagerW2;
       ...
       PackageManager manager = this.getPackageManager();
		...
		if(trans == true){
			new Handler().postDelayed(new Runnable() {
				@Override
				public void run() {
					appIcon.setAlpha(RecieverWiFi.alpha);
				}
			}, 2000);
		}

		windowManagerW2 = (WindowManager) getSystemService(WINDOW_SERVICE);
		...
		windowManagerW2.addView(chatHead, params);
		...
		try {
			chatHead.setOnTouchListener(new View.OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					if(trans == true){
						appIcon.setAlpha(RecieverWiFi.opacity);
						new Handler().postDelayed(new Runnable() {
							@Override
							public void run() {
								appIcon.setAlpha(RecieverWiFi.alpha);
					...
					case MotionEvent.ACTION_MOVE:
						...
						windowManagerW2.updateViewLayout(chatHead, paramsF);
						break;
					}
					return false;
				}
			...
			chatHead.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if(RecieverWiFi.WiFi2 == false){
						stopService(new Intent(getApplicationContext(), Floating_WiFi2.class));
						run = false;
	...
	public void onCreate() {
		...
		System.out.println("Floating_WiFi2");
	}
	...
	public void onDestroy() {
		...
		if (chatHead.isShown()) {
			windowManagerW2.removeView(chatHead);

			RecieverWiFi.WiFi2 = true;
			System.out.println("Channel Floating_WiFi2 Reset");
		}
	}
