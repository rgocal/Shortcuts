...
public class TimeHelper1 extends Activity{

	static boolean time1 = true;
	...
	protected void onCreate(Bundle Saved){
		...
		System.out.println("TimeHelper1");
		...
		Intent s = new Intent(TimeHelper1.this, Floating_TIME1.class);
