...
public class Floating_Bluetooth1 extends Service {


	private WindowManager windowManagerB1;
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
       ...
       PackageManager manager = this.getPackageManager();
		...
		windowManagerB1 = (WindowManager) getSystemService(WINDOW_SERVICE);
		...
		windowManagerB1.addView(chatHead, params);
		...
		try {
			chatHead.setOnTouchListener(new View.OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_MOVE:
						...
						windowManagerB1.updateViewLayout(chatHead, paramsF);
						break;
					}
					return false;
				}
			...
			chatHead.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if(RecieverBluetooth.blue1 == false){
						stopService(new Intent(getApplicationContext(), Floating_Bluetooth1.class));
						run = false;
	...
	public void onCreate() {
		...
		System.out.println("Floating_Bluetooth1");
	}
	...
	public void onDestroy() {
		...
		if (chatHead.isShown()) {
			windowManagerB1.removeView(chatHead);

			RecieverBluetooth.blue1 = true;
			System.out.println("Channel Floating_Bluetooth1 Reset");
		}
	}
