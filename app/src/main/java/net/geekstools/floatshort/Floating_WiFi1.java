...
public class Floating_WiFi1 extends Service {


	private WindowManager windowManagerW1;
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
       ...
       PackageManager manager = this.getPackageManager();
		...
		windowManagerW1 = (WindowManager) getSystemService(WINDOW_SERVICE);
		...
		windowManagerW1.addView(chatHead, params);
		...
		try {
			chatHead.setOnTouchListener(new View.OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_MOVE:
						...
						windowManagerW1.updateViewLayout(chatHead, paramsF);
						break;
					}
					return false;
				}
			...
			chatHead.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if(RecieverWiFi.WiFi1 == false){
						stopService(new Intent(getApplicationContext(), Floating_WiFi1.class));
						run = false;
	...
	public void onCreate() {
		...
		System.out.println("Floating_WiFi1");
	}
	...
	public void onDestroy() {
		...
		if (chatHead.isShown()) {
			windowManagerW1.removeView(chatHead);

			RecieverWiFi.WiFi1 = true;
			System.out.println("Channel Floating_WiFi1 Reset");
		}
	}
